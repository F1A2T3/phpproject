            ...
            <form name="formSup" method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                if (isset($_SESSION['msg_suppu'])) {
                        echo '<span style="color:red;display:block ruby;">'.$_SESSION['msg_suppu'].'</span>';
