<?php
    ...
    include_once "connection.php";
     ...
     $sql = "SELECT * FROM matchclub 
     WHERE WEEK(temp_debut, 1) = WEEK(DATE_ADD(NOW(), INTERVAL 1 WEEK), 1) 
     AND WEEK(temp_fin, 1) = WEEK(DATE_ADD(NOW(), INTERVAL 1 WEEK), 1) 
     AND id_terrain = $terrain 
     AND (statut = 'accept' OR statut = 'fixe')";
