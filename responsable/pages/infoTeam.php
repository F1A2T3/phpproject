                    ...
                    <div class="row">
                            ...
                            <div class="tab-content profile-tab" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <br>
                                            ...
                                            if(is_null($data1[4])){
                                            ?>
                                              <p>Veuillez choisir un nouveau capitaine pour cette équipe.</p>
                                            <?php  
                                            }
                                            else{
                                            if($nb_lines>0){?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                ?>
                                            <div class="col-md-6">
                                                <p>Le capitaine de cette équipe a été supprimé.
                                                </p>
                                                <?php }
                                                ?>
                                            </div>
                        ...
                        <div class="">
                            <div class="profile-work">
                                <div class="">
                                     <button type="button" class="btn1 btn col-md-12" onclick="window.location.href='listeMembres.php?equipe=<?php echo $nom_equipe; ?>'" style="width: 264px;height: 58px;">Liste des membres <img src="../../Images/right-arrow-svgrepo-com.svg"></button><br><br><br>
                                     <button type="button" class="btn1" onclick="window.location.href='updateEquipe.php?equipe=<?php echo $nom_equipe; ?>'"style="width: 191px;height: 58px;">Modifier<img src="../../Images/right-arrow-svgrepo-com.svg"></button><br><br><br>
                                     <button type="button" class="btn1" onclick="window.location.href='deleteEquipe.php?equipe=<?php echo $nom_equipe; ?>'"style="width: 190px;height: 58px;">Supprimer <img src="../../Images/right-arrow-svgrepo-com.svg"></button><br><br><br>
                                </div>
                            </div>
                        </div>
                    </div>
