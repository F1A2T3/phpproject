<?php
    ...
    include_once "connection.php";
     ...
     $result->execute(array(':terrain'=>$terrain));
        ...
        <main>
            <ul class="box-info">
                <li>
                    ...
                    <button class="button-7 bx" role="button" style="width:80px;height:28px;background-color: rgb(255,253,44);color: #16774a; border-color :rgb(255,253,44); font-size: 16px;" onclick="window.location.href='RespoReservInfo.php'">Ajouter</button>
                </li>
            </ul>
