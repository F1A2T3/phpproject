<?php
    ...
    if(isset($_POST['subm']))
    {
        ...
        $CIN = strtoupper(htmlspecialchars($_SESSION['CIN']));
            ...
            if($equipe == 'newEquipe'){
                ...
                if($row1==0){
                    ...
                    //echo "equipe inserted";
                        ...
                        $error_msg_equipe = "Le nom d'équipe que vous avez choisi existe déja.";
                    ...
                    $reponse=$bdd->prepare('SELECT u.Type FROM user u,equipe e WHERE e.Capitaine = u.CIN AND u.Nom_equipe = :equipe');
