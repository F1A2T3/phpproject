<?php session_start();
   $_SESSION['Login']=$_SESSION['CIN'];
   $_SESSION['mdp']=sha1($_SESSION['password']);    
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
        <div class="navbar">
         ...
         <div class="wrapper" style="height: 660px; width: 500px; left:180px;padding-left: 40PX;margin-left: 111px;">
               <h2 class="signh2" >sign-up</h2><br>
               <?php
                        if (isset($_SESSION['error_msg_equipe'])) {
                            echo '<br>  <span style="color:red;display:block ruby;">'.$_SESSION                           ['error_msg_equipe'].'</span>';
                            unset($_SESSION['error_msg_equipe']);
                        }

                        if (isset($_SESSION['error_msg_type'])) {
                            echo '<br>  <span style="color:red;display:block ruby;">'.$_SESSION                           ['error_msg_type'].'</span>';
                            unset($_SESSION['error_msg_type']);
                        }?><br>
